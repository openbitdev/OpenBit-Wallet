...
export function useCall <T> (fn: TrackFn | undefined | null | false, params?: CallParams | null, options?: CallOptions<T>, depth?: any): T | undefined {
  ...
  useEffect((): void => {
    ...
    if (mountedRef.current && fn) {
      const [serialized, mappedParams] = extractParams(fn, params || [], options, depth);
  ...
  }, [fn, options, mountedRef, params, depth]);
