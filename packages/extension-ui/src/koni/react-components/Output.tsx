...
import cloneIconLight from "@polkadot/extension-ui/assets/clone--color-2.svg";
import cloneIconDark from "@polkadot/extension-ui/assets/clone--color-3.svg";
import useTranslation from "@polkadot/extension-ui/hooks/useTranslation";
import {Theme, ThemeProps} from "@polkadot/extension-ui/types";
  ...
  return (
    ...
    >
      ...
      <CopyToClipboard text={(value && value) || ''}>
        <div className={'kn-copy-btn'} onClick={_onCopy}>
          {theme === 'dark' ?
            (
              <img src={cloneIconDark} alt="copy"/>
            ) : (
              <img src={cloneIconLight} alt="copy"/>
            )
          }
        </div>
      </CopyToClipboard>
