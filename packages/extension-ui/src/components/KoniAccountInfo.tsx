...
import cloneLogo from "@polkadot/extension-ui/assets/clone.svg";
...
function KoniAccountInfo ({address, children, className, genesisHash, isExternal, isHardware, name, parentName, suri, type: givenType }: Props): React.ReactElement<Props> {
...
export default styled(KoniAccountInfo)(({ theme }: ThemeProps) => `
