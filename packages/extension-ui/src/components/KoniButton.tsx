...
function KoniButton ({ children, className = '', isBusy, isDisabled, onClick, to }: Props): React.ReactElement<Props> {
...
export default styled(KoniButton)(({ isDanger, theme }: Props) => `
