...
import { _ValidateCustomAssetRequest, _ValidateCustomAssetResponse, _ValidateCustomBrc20Request, _ValidateCustomBrc20Response } from '@subwallet/extension-base/services/chain-service/types';
