...
import { BIT84_ACCOUNT_TYPE, BITTEST84_ACCOUNT_TYPE } from '@subwallet/extension-koni-ui/constants/account';
...
const Component: React.FC<SelectAccountTypeProps> = (props: SelectAccountTypeProps) => {
  ...
  const items = useMemo((): AccountTypeItem[] => ([
    ...
    {
      icon: 'bitcoin',
      key: BITTEST84_ACCOUNT_TYPE,
      label: 'Test net',
      onClick: onClickItem(BITTEST84_ACCOUNT_TYPE)
    }
  ]), [onClickItem]);
