...
const Component = ({ className }: Props) => {
  ...
  const ListTermSeedPhrase: Record<TermSeedPhrase, string> = useMemo(() => ({
    [TermSeedPhrase.TERM_1]: t('OpenBit doesn’t keep any copy of your seed phrase and other backup methods.'),
    [TermSeedPhrase.TERM_2]: t('OpenBit can’t help you recover your account once your seed phrase or other backup methods are lost.'),
