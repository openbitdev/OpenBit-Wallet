...
export const DataContextProvider = ({ children }: DataContextProviderProps) => {
  ...
  // Init subscription
  // Common
  _DataContext.addHandler({ ...subscribeAccountGroupsData, name: 'subscribeAccountGroupsData', relatedStores: ['accountState'], isStartImmediately: true });
