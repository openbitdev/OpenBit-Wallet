...
import { _getContractAddressOfToken, _isCustomAsset, _isRuneToken, _isSmartContractToken } from '@subwallet/extension-base/services/chain-service/utils';
    ...
    return [
      {
        ...
        disabled: !(_isCustomAsset(tokenInfo.slug) && (_isSmartContractToken(tokenInfo) || _isRuneToken(tokenInfo)))
      }
    ];
