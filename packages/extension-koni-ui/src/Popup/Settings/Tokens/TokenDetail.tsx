...
import { _getContractAddressOfToken, _isBrc20Token, _isCustomAsset, _isSmartContractToken } from '@subwallet/extension-base/services/chain-service/utils';
    ...
    return [
      {
        ...
        disabled: !(_isCustomAsset(tokenInfo.slug) && (_isSmartContractToken(tokenInfo) || _isBrc20Token(tokenInfo)))
      }
    ];
