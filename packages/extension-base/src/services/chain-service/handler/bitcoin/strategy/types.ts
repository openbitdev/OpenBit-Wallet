...
import { BitcoinAddressSummaryInfo, RunesInfoByAddress, RuneTxs } from '@subwallet/extension-base/services/chain-service/handler/bitcoin/strategy/BlockStream/types';
...
export interface BitcoinApiStrategy extends Omit<ApiRequestStrategy, 'addRequest'> {
  ...
  getRuneTxsUtxos (address: string): Promise<RuneTxs[]>;
