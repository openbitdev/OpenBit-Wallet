...
const filterAddress = (addresses: string[], chainInfo: _ChainInfo): [string[], string[], string[]] => {
  ...
  if (isEvmChain) {
    return [evmAddresses, substrateAddresses, bitcoinAddresses];
  } else {
    ...
    return [fetchList, [...unfetchList, ...evmAddresses], bitcoinAddresses];
  }
};
