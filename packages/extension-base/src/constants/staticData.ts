...
export const staticDataRaw = {
  md: 'These Terms of Use (“Agreement”) set forth the general terms and conditions of your use of the OpenBit extension application ("OpenBit Application") and any of its related products and services (collectively, “Services”).\n' +
    '\n' +
    ...
    '\n' +
    'Although the OpenBit Application and Services may link to other resources (such as websites, other applications, etc.), we are not, directly or indirectly, implying any approval, association, sponsorship, endorsement, or affiliation with any linked resource, unless specifically stated herein. We are not responsible for examining or evaluating, and we do not warrant the offerings of any businesses or individuals or the content of their resources.\n' +
    '\n' +
    'We do not assume any responsibility or liability for the actions, products, services, and content of any other third parties. You should carefully review the legal statements and other conditions of use of any resource that you access through a link in the OpenBit Application. Your linking to any other off-site resources is at your own risk.\n' +
    '\n' +
    '#### **Prohibited uses**\n' +
    '\n' +
    'In addition to other terms as set forth in the Agreement, you are prohibited from using the OpenBit Application and Services:\n' +
    '\n' +
    ...
    '7. To upload or transmit viruses or any other type of malicious code that will or may be used in any way that will affect the functionality or operation of the OpenBit Application and Services, third-party products and services, or the Internet\n' +
    '8. To spam, phish, pharm, pretext, spider, crawl, or scrape\n' +
    '9. For any obscene or immoral purpose\n' +
    '10. To interfere with or circumvent the security features of the OpenBit Application and Services, third-party products and services, or the Internet.\n' +
    '\n' +
    ...
    '\n' +
    'This Agreement does not transfer to you any intellectual property owned by the Operator or third parties, and all rights, titles, and interests in and to such property will remain (as between the parties) solely with the Operator. All trademarks, service marks, graphics, and logos used in connection with the OpenBit Application and Services, are trademarks or registered trademarks of the Operator or its licensors.\n' +
    '\n' +
    'Other trademarks, service marks, graphics, and logos used in connection with the OpenBit Application and Services may be the trademarks of other third parties. Your use of the OpenBit Application and Services grants you no right or license to reproduce or otherwise use any of the Operator or third-party trademarks.\n' +
    '\n' +
    ...
    '#### **Indemnification**\n' +
    '\n' +
    'You agree to indemnify and hold the Operator and its affiliates, directors, officers, employees, agents, suppliers, and licensors harmless from and against any liabilities, losses, damages, or costs, including reasonable attorneys’ fees, incurred in connection with or arising from any third-party allegations, claims, actions, disputes, or demands asserted against any of them as a result of or relating to your use of the OpenBit Application and Services or any willful misconduct on your part.\n' +
    '\n' +
    '#### **Severability**\n' +
    '\n' +
    ...
    '\n' +
    'We reserve the right to modify this Agreement or its terms related to the OpenBit Application and Services at any time at our discretion. When we do, we will revise the updated date at the bottom of this page. We may also provide notice to you in other ways at our discretion, such as through the contact information you have provided.\n' +
    '﻿****\n' +
    'An updated version of this Agreement will be effective immediately upon the posting of the revised Agreement unless otherwise specified. Your continued use of the OpenBit Application and Services after the effective date of the revised Agreement (or such other act specified at that time) will constitute your consent to those changes.\n' +
    '\n' +
    '#### **Acceptance of these terms**\n' +
    '\n' +
    'You acknowledge that you have read this Agreement and agree to all its terms and conditions. By accessing and using the OpenBit Application and Services you agree to be bound by this Agreement. If you do not agree to abide by the terms of this Agreement, you are not authorized to access or use the OpenBit Application and Services.\n' +
    '\n' +
    '#### **Contacting us**\n' +
    '\n' +
