...
import { _BitcoinApi, _ChainState, _EvmApi, _NetworkUpsertParams, _SubstrateApi, _ValidateCustomAssetRequest, _ValidateCustomAssetResponse, _ValidateCustomBrc20Request, _ValidateCustomBrc20Response, EnableChainParams, EnableMultiChainParams } from '@subwallet/extension-base/services/chain-service/types';
...
export interface ApiMap {
  ...
  bitcoin: Record<string, _BitcoinApi>;
}
