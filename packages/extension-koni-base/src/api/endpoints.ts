...
const NETWORKS: Record<string, NetWorkInfo> = {
  ...
  aleph: {
    ...
    provider: 'Aleph Zero Foundation',
    groups: ['MAIN_NET'],
    nativeToken: 'AZERO',
