...
export default class KoniExtension extends Extension {
  ...
  private async accountsCreateWithSecret ({ publicKey,
    secretKey,
    password,
    isAllow,
    name }: RequestAccountCreateWithSecretKey): Promise<ResponseAccountCreateWithSecretKey> {
    try {
