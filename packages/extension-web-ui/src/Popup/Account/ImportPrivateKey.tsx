...
import { CloseIcon, Layout, PageWrapper, PrivateKeyInput } from '@subwallet/extension-web-ui/components';
...
import { useAutoNavigateToCreatePassword, useCompleteCreateAccount, useDefaultNavigate, useFocusFormItem, useGetDefaultAccountName, useGoBackFromCreateAccount, useTranslation, useUnlockChecker } from '@subwallet/extension-web-ui/hooks';
import { createAccountSuriV2, validateMetamaskPrivateKeyV2 } from '@subwallet/extension-web-ui/messaging';
import { FormCallbacks, ThemeProps, ValidateState } from '@subwallet/extension-web-ui/types';
